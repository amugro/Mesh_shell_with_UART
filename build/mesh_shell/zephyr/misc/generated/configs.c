...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_STACK_SIZE, 3048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 2200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ISR_STACK_SIZE, 1500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_TX_PACKET_COUNT, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_ADV_STACK_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SUBNET_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_ONOFF_CLI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PRIVATE_SHELL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_NODE_COUNT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_SUBNET_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_APP_KEY_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_DFU_FWID_MAXLEN, 106);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_SCAN_LATENCY, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_PROV_CTX_INSTANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_CDB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_LOW_POWER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_TEST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_HEALTH_SRV_INSTANCE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_GATT_PROXY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_HEALTH_CLI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_CFG_CLI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MAX_CONN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_STATISTIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_DUMMY_BUF_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FLASH_NRF_RADIO_SYNC_MPSL_NORMAL_PRIORITY_TIMEOUT_US, 5000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_UARTE20_SECURE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_SECURE_UART20, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_PROCESS_THREAD_SLEEP_MS, 250);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_DUMMY_INIT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_DUMMY_INIT_LOG_LEVEL, 3);
