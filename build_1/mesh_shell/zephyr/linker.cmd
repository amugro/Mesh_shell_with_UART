...
ztest :
{
 ...
 bt_mesh_subnet_cb_area : { _bt_mesh_subnet_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_subnet_cb.static.*))); _bt_mesh_subnet_cb_list_end = .;; } > FLASH
 bt_mesh_app_key_cb_area : { _bt_mesh_app_key_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_app_key_cb.static.*))); _bt_mesh_app_key_cb_list_end = .;; } > FLASH
 bt_mesh_hb_cb_area : { _bt_mesh_hb_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_hb_cb.static.*))); _bt_mesh_hb_cb_list_end = .;; } > FLASH
 bt_mesh_friend_cb_area : { _bt_mesh_friend_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_friend_cb.static.*))); _bt_mesh_friend_cb_list_end = .;; } > FLASH
 bt_mesh_lpn_cb_area : { _bt_mesh_lpn_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_lpn_cb.static.*))); _bt_mesh_lpn_cb_list_end = .;; } > FLASH
 bt_mesh_proxy_cb_area : { _bt_mesh_proxy_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_mesh_proxy_cb.static.*))); _bt_mesh_proxy_cb_list_end = .;; } > FLASH
